...
namespace Kismeta.Game.Bootstrap
{
    ...
    public sealed class GameBootstrap : MonoBehaviour
    {
        ...
        [SerializeField] private VisualTreeAsset _crucibleCodexReference;
        ...
        private void EnsureProductionUi()
        {
            ...
            EnsureController<CrucibleCodexReferenceController>();
            ...
            endOverlays?.Configure(_cardTable, _cardModals, _activeEffects, _crucibleCardDetail, _crucibleCodexReference, _placeWards);
