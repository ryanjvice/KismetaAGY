    ...
    public static class NarrativeSlotCatalogDefaults
    {
        public static IReadOnlyList<NarrativeSlotEntry> SpringSlice { get; } = new[]
        {
            ...
            new NarrativeSlotEntry(
                ...
                0,
                string.Empty,
                "Before cards lock, use your tools — read effects and commune with your tableau.",
                string.Empty,
                new[] { "Focus" }),
            new NarrativeSlotEntry(
                "spring.setage",
            ...
            new NarrativeSlotEntry(
                ...
                NarrativeSlotTier.Action,
                3,
                "Watch each card arrive in your spread, hand, or arcanum.",
                "Fate and Adept cards pause the deal until you resolve them.",
                "Death and other fates may change the table before the harvest ends.",
                new[] { "Receiving cards" }),
            new NarrativeSlotEntry(
                "spring.hub",
                Season.Spring,
        ...
        public static IReadOnlyList<NarrativeSlotEntry> SummerSlice { get; } = new[]
        {
            new NarrativeSlotEntry(
                ...
                NarrativeSlotTier.Transition,
                0,
                "The sun rides high. Trade, duel, gambit, and build as you will.",
            ...
            new NarrativeSlotEntry(
                ...
                0,
                string.Empty,
                "This round is for consorting and building — review Codex and the Table, then Trade, Duel, Gambit, and Build Astral Houses as opportunities arise.",
                string.Empty,
                new[] { "Focus" }),
            new NarrativeSlotEntry(
                "summer.hub",
                ...
                NarrativeSlotTier.Action,
                1,
                "Take your turn beneath the high sun. Consort with rivals or build a House.",
                "Take any actions, in any order, as many as you can fuel.",
                string.Empty,
                new[] { "Trade", "Duel", "Gambit", "Build A House", "Finish Turn" }),
            new NarrativeSlotEntry(
                "summer.passed",
                Season.Summer,
                NarrativeSlotTier.Action,
        ...
        public static IReadOnlyList<NarrativeSlotEntry> AutumnSlice { get; } = new[]
        {
            new NarrativeSlotEntry(
                ...
                NarrativeSlotTier.Transition,
                0,
                "The crucible runs hot. Craft, activate, oppose, and drive your stone toward gold.",
                "Take any actions, in any order, as many as you can fuel — craft, activate, oppose, and advance at the forge.",
                string.Empty,
                new[] { "Begin Autumn" },
                "Forging"),
            new NarrativeSlotEntry(
                ...
                0,
                string.Empty,
                "The forge is live — cross-check Codex costs before you Oppose, Fire, Temper, or break Stasis.",
                string.Empty,
                new[] { "Focus" }),
            new NarrativeSlotEntry(
                "autumn.survey",
